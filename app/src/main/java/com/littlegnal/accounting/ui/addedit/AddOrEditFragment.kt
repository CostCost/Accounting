...
class AddOrEditFragment : BaseMvRxFragment() {
  ...
  private val accountingId: Int by args()

  private val disposables = CompositeDisposable()

  private val mainMvRxViewModel by activityViewModel(MainMvRxViewModel::class)

  private val addOrEditMvRxViewModel by fragmentViewModel(AddOrEditMvRxViewModel::class)

  override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
    return inflater.inflate(R.layout.activity_add_or_edit, container, false)
  }
...
//    findNavController().navigate()
    ...
    addOrEditMvRxViewModel.loadAccounting(accountingId)
  }
